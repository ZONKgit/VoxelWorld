...
namespace VoxelWorld.Classes.Render
{
    public class Clouds
    {
        ...
        public void RenderProcess()
        {
            ...
            GL.TexCoord2(0+Offset.X,0+Offset.Y); GL.Vertex3(Position.X-100, Height, Position.Y+100);
            GL.TexCoord2(1+Offset.X, 0+Offset.Y); GL.Vertex3(Position.X-100, Height, Position.Y-100);
            GL.TexCoord2(0+Offset.X, 1+Offset.Y); GL.Vertex3(Position.X+100, Height, Position.Y+100);
            GL.TexCoord2(1+Offset.X, 1+Offset.Y);GL.Vertex3(Position.X+100, Height, Position.Y-100);
